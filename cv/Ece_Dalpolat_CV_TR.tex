...
\begin{center}
  ...
  {\small
  ecedlplt9850@gmail.com \,|\, İstanbul\\[0.2em]
...
\textbf{Luna AI — AI Tabanlı İK Yönetim Sistemi} \,|\, \textit{TUBITAK Destekli} \hfill Haz 2026 -- Ağu 2026\\
Çok kiracılı vektör tabanlı iş-aday matching: PostgreSQL + pgvector + HNSW, multi-tenant RLS, fairness metrics, PII anonimizasyonu, LLM baselines. Sorumluluk: Backend, veri pipeline, ML fairness, onboarding.
\vspace{0.5em}
...
\textbf{Yüksek Lisans, Bilgi Teknolojileri} \hfill 2024 -- 2026\\
